...
class TestCfg(TestCase):
    def test_access(self):
        ...
        self.assertEqual('gpt', cfg['dataset::articles_part-edged/layout/tokenizer/target_model'])

    def test_access2(self):
        cfg = Cfg.parse('cfg/test/test2.cfg')
        self.assertEqual('gpt', cfg['trainer::minigpt_articles-part/dataset/layout/tokenizer/target_model'])

    def test_access3(self):
        cfg = Cfg.parse('cfg/test/test3.cfg')
        self.assertEqual(30_000, cfg['trainer::minigpt_articles-64/dataset/layout/tokenizer/vocab_size'])
    ...
    def test_attrs_2(self):
        cfg = Cfg.parse('cfg/test/test3.cfg')
        sect = cfg['trainer::minigpt_articles-64']
